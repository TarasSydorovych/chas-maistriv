...
// const apiKey = "Bearer NWQwZGE2ZGYzZDYyNTQzNjJmMWJlMjA5OTE3MTFlNmI3ZjQyNTBmZQ";
...
//   try {
//     const apiUrl =
//       "https://openapi.keycrm.app/v1/order?limit=15&page=1&sort=id&filter[status_id]=1";
...
//       res.json(firstOrder);
//     } else {
//       res.json({ message: "Немає доступних замовлень." });
//     }
//   } catch (error) {
//     console.error("Помилка: " + error.message);
