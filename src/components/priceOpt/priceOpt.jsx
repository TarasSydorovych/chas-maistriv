...
import ElectroObig from "./electoObig";
import {
  getAuth,
...
import ActionsAnd from "./actionsAnd";
export default function PriceOpt({ windowDimensions, setCartCounterC }) {
    ...
    const fetchData = async () => {
      ...
      const updatedProductsData = obj.reduce((acc, item) => {
        const matchingProducts = products.filter(
          (product) => product.seria === item.name
        );
  ...
  return (
    <div>
      ...
      <div className={css.titleWrap}>
        <h3 className={css.h3Title}>
          На цій сторінці зручно робити гуртові замовлення
        </h3>
        {windowDimensions && (
          <>
            <div className={css.birdWrapFirst}>
              <div className={css.birdWrap}>
                ...
                <p className={css.birdPDesc}>
                  В графі “замовлення” проставте кількість{" "}
                </p>
              </div>
              ...
              <div className={css.birdWrap}>
                ...
                <p className={css.birdPDesc}>
                  В кінці прайсу тицьніть на кнопку “замовити” і в кошик буде
                  додано одразу всі книги, навпроти яких у графі “замовлення”
                  стоїть цифра
                </p>
              </div>
              <img src={arrowBirdOpt} className={css.arrowBirdOptSt} />
              <div className={css.birdWrap}>
                ...
                <p className={css.birdPDesc}>
                  Прямо з кошика можна відкоригувати замовлення, додати або
                  видалити примірники книг{" "}
                </p>
              </div>
              <img src={arrowBirdOpt} className={css.arrowBirdOptSt} />
            </div>
            <div className={css.birdWrapSecond}>
              ...
              <div className={css.birdWrap}>
                <img src={optBirdFour} />
                <p className={css.birdPDesc}>
                  Ваша гуртова знижка підтягнеться автоматично, треба лише
              ...
              <div className={css.birdWrap}>
                <img src={optBirdFive} />
                <p className={css.birdPDesc}>
                  Якщо у вас відсутній акаунт, але ви хочете долучитись до
                  розповсюдження книг видавництва, зареєструєтесь як партнер у
                  одній з запропонованих ролей і ви отримаєте персональну знижку
                </p>
              </div>
              <img src={arrowBirdOpt} className={css.arrowBirdOptSt} />
              <div className={css.birdWrap}>
                ...
                <p className={css.birdPDesc}>
                  {" "}
                  Кожен рядок інтерактивний. Ви можете перейти з нього на
                  сторінку книги та дізнатись про неї більше, подивитись відео
                  чи опис книги
                </p>
              </div>
            </div>
      ...
      <div className={css.blockTextWrap}>
        <div className={css.blockTextWrapSmall}>
          <p className={css.pBlockTextWrap}>
            Ми продаємо книги, як місіонери. Тобто продаємо лише ті книги, що
            мають в собі меседж, і наше завдання донести цей меседж до людини.
            Якщо меседж її “торкне”, вона купить книгу та прийде знов у
            майбутньому. Наша мета — не продати книгу, а донести її головну
            ідею. Якщо ви розповсюджуєте наші книжки, ми радимо читати їх або
            (як мінімум) дивитись відео, в яких ми доносимо меседж кожного
            видання. В такому разі ви зможете донести цей меседж до покупців.
            Якщо продавець знає книгу та чим вона може прорости в дитині, це
            значно підвищує продажі. Це не теорія — це наш досвід, перевірений
            на практиці.
          </p>
...
<p className={css.childrenLike}>Дітям дуже цікаво дізнатись, хто такий Миколай і чому він дарує всім подарунки.ТУТ МАЄ БУТИ ОПИС КНИГИ “Поліанна”.</p>
      ...
      {productsData.map((item, index) => {
        return (
          <div key={index} className={css.theBestForChildren}>
            <h5 className={css.theBestForChildrenH5}>{item.name}</h5>
