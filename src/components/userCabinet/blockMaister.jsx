    ...
    return(
        <div className={css.readerUserWrap}>
            ...
            <div className={css.readerUserWrapSmall}>
                <h1 className={css.aboutCompanyH1}><a className={css.aboutCompanyH1} href='https://forms.gle/L3pAwFmuMGCR24ZY6' target='_blanck'>Анкета Автора/ перехід на гугл-форму/ в будь-який момент Ви можете її редагувати</a></h1>
                <p className={css.paragInWrapBig}>{data[0].updateData}</p>
                <h1 className={css.aboutCompanyH1}><a className={css.aboutCompanyH1} href='https://forms.gle/eDYkfEDi6tk4Fhjj6' target='_blanck'>Анкета майстра (художника, типографіка, дизайнера, редактора, психолога, наукового редактора, критика) для публікації сторінки на сайті/ перехід на гугл-форму/ в будь-який момент Ви можете її редагувати</a></h1>
                ...
                <h1 className={css.aboutCompanyH1}><a className={css.aboutCompanyH1} href='https://forms.gle/MuM2M5giHzKQMWjp9' target='_blanck'>Публікація рукопису на сайті з метою дослідження/перехід до гугл-форми з анкетою рукопису</a></h1>
