        ...
        <ul className="ulFirstfilter">
          <li className="ulFirstfilterLi">
            <div
              ...
              onClick={() => {
                handleFilterClick({ field: "predprodag", value: "Предпродаж" });
                handleFilterClickst({
                  field: "predprodag",
                  value: "Предпродаж",
                });
          ...
          <li className="ulFirstfilterLi">
            <div
              className={`blockCheckFilterJoin ${
                filters.some(
                  (selectedFilter) =>
                    selectedFilter.field === "lastExam" &&
                    selectedFilter.value === "Останній екземпляр"
                )
                  ? "selected"
                  : ""
              }`}
          ...
          <li className="ulFirstfilterLi">
            <div
              className={`blockCheckFilterJoin ${
                filters.some(
                  (selectedFilter) =>
                    selectedFilter.field === "svjatkovi" &&
                    selectedFilter.value === "Святкові"
                )
                  ? "selected"
                  : ""
              }`}
